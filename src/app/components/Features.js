  ...
  return (
    <div className={classes.root}>
      <FormControl required component="fieldset" className={classes.formControl}>
        ...
        <FormGroup>
          <FormControlLabel
            control={<GreenCheckbox checked={pool} onChange={handleChange} name="pool" />}
            label="Pool"
          />
          <FormControlLabel
            control={<GreenCheckbox checked={attached_garage} onChange={handleChange} name="attached_garage" />}
            label="Attached Garage"
          />
          <FormControlLabel
            control={<GreenCheckbox checked={basement} onChange={handleChange} name="basement" />}
            label="Basement"
          />
        </FormGroup>
